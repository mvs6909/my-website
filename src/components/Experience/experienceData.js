const experienceData = [
    {   id:0,
        ...
        skills: ["Data Structures", "Algorithms","Python","Java","Public speaking","Facilitation"],
        color: "#0ecf75",
    ...
    },
    {
        ...
        skills: ["Python", "Django","Github","Vue.js","REST API"],
        color: "#4512c7",
    ...
    {   id:2,
        ...
        skills: ["Javascript", "SQL","Burp Suite", "OWASP", "Kali Linux", "Facilitation", "Technical Manager"],
        color: "#0ecf75",
